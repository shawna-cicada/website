...
export const homepageContent: HomepageContent = {
  ...
  recognition: {
    ...
    statements: [
      ...
      "The strategy has become harder to see in the day-to-day.",
      "Leaders leave meetings aligned, but make different decisions afterward.",
      "Teams are busy, but the business isn't moving faster.",
